...
class _AltaVehiculoPantallaState extends State<AltaVehiculoPantalla> {
  ...
  bool _validar() {
    ...
    setState(() {
      errorRed = null;
      errorMarca = marcaCtrl.text.trim().isEmpty ? 'Ingresa la marca del vehiculo.' : null;
      errorModelo =
          modeloCtrl.text.trim().isEmpty ? 'Ingresa el modelo del vehiculo.' : null;
      if (anioRaw.isEmpty) {
      ...
      errorPlaca =
          placaCtrl.text.trim().isEmpty ? 'Ingresa la placa para reconocer el vehiculo.' : null;
    });
  ...
  Future<void> guardar() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          errorRed =
              'No se pudo guardar el vehiculo. Revisa la conexion e intenta de nuevo.';
        });
      }
    }
