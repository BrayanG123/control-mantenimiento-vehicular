                ...
                child: BotonAcceso(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => IniciarSesionPantalla(onSesion: onSesion),
                      ),
                    );
                  },
                ),
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => CrearCuentaPantalla(onSesion: onSesion),
                      ),
                    );
                  },
...
class _IniciarSesionPantallaState extends State<IniciarSesionPantalla> {
  ...
  void enviar() {
    ...
    } else if (!Sesion.correoConFormato(correo)) {
      errCorreo = 'El correo no tiene formato valido. Ejemplo: mariana@correo.com';
    }
    if (clave.isEmpty) {
    ...
    final fallo = Sesion.iniciar(correo, clave);
    if (fallo != null) {
  ...
  Widget build(BuildContext context) {
    return HojaAcceso(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Iniciar sesion',
          style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: texto),
        ),
      ),
      body: ListView(
          ...
          Align(
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const OlvideClavePantalla()),
                );
              },
          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => CrearCuentaPantalla(onSesion: widget.onSesion),
                ),
              );
            },
            child: const Text('Crear cuenta'),
...
class _CrearCuentaPantallaState extends State<CrearCuentaPantalla> {
  ...
  void enviar() {
    ...
    final fallo = Sesion.crear(correo, clave);
    if (fallo != null) {
...
class _OlvideClavePantallaState extends State<OlvideClavePantalla> {
  ...
  void enviar() {
    ...
    if (!Sesion.correoConFormato(correo)) {
      setState(() {
        errorCorreo =
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => EnlaceEnviadoPantalla(correo: Sesion.normalizar(correo)),
      ),
    );
  }
